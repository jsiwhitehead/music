{
  ...
  [
    ...
    [
      ...
      opacity: 1
      ~
      [base[1] + 9 * chunk, base[2] + 150 - 1 - 3.5 * size]
      [chunk, 1]
    ]
    root(0, 9, 2)
    note(0, 9.25, 2, 5, no)
    ...
    [
      ...
      opacity: 1
      ~
      [base[1] + 2 * chunk, base[2] + 150 - 1 + 1 * rowmove - 4 * size]
      [chunk, 1]
    ]
    [
      shape: 'rect'
      ...
      opacity: 1
      ~
      [base[1] + 2 * chunk, base[2] + 150 + 1 * rowmove - 5 * size]
      [chunk, (size - 1)]
    ]
    root(1, 2, 3.5)
    note(1, 2.5, 6, 1, no)
    ...
    [
      ...
      opacity: 1
      ~
      [base[1] + 6 * chunk, base[2] + 150 - 1 + 1 * rowmove - 4 * size]
      [chunk, 1]
    ]
    [
      shape: 'rect'
    ...
    [
      ...
      opacity: 1
      ~
      [base[1] + 12 * chunk, base[2] + 150 + 1 * rowmove - 1 - 3.5 * size]
      [chunk, 1]
    ]
    root(1, 12, 2)
    note(1, 12, 6, 1, no)
    ...
    [
      ...
      opacity: 1
      ~
      [base[1] + 3 * chunk, base[2] + 150 - 1 + 2 * rowmove - 2.5 * size]
      [chunk, 1]
    ]
    [
      shape: 'rect'
